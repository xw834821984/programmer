...
import com.xw.programmer_nucleus.ui.recycler.ItemType;
import com.xw.programmer_nucleus.ui.recycler.MultipleFields;
...
import com.xw.programmer_nucleus.ui.recycler.MultipleViewHolder;
    ...
    protected void convert(final MultipleViewHolder holder, final MultipleItemEntity entity) {
        ...
        switch (holder.getItemViewType()) {
            case ItemType.VERTICAL_MENU_LIST:
                ...
                //OnClickListener 不写在整个类上这是没有用的，容易窜。 这里直接使用匿名内部类的办法
